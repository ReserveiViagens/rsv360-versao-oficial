...
export const designTokens = {
  ...
  animations: {
    ...
    // Framer-motion aceita: "easeInOut" | "easeIn" | "easeOut" | "linear" | [number, number, number, number]
    // NÃO aceita strings CSS como "cubic-bezier(...)"
    easing: {
    ...
    // Para uso em CSS (transition-timing-function)
    easingCss: {
