...
export default function Dashboard() {
    ...
    const categories: Category[] = [
        ...
        },
        {
            ...
            color: 'teal',
            services: [
                { name: 'Dashboard', port: 3001, status: 'online', icon: '📊', description: 'Dashboard de cotações' },
                { name: 'Nova Cotação', port: 3001, status: 'online', icon: '➕', description: 'Criar nova cotação' },
                { name: 'Templates', port: 3001, status: 'online', icon: '📋', description: 'Templates de cotação' },
                { name: 'Hotéis', port: 3001, status: 'online', icon: '🏨', description: 'Cotações de hotéis' },
                { name: 'Parques', port: 3001, status: 'online', icon: '🎢', description: 'Cotações de parques' },
                { name: 'Atrações', port: 3001, status: 'online', icon: '🎡', description: 'Cotações de atrações' },
                { name: 'Passeios', port: 3001, status: 'online', icon: '🚌', description: 'Cotações de passeios' }
            ]
        }
    ];
                        ...
                        <div className="flex justify-between items-center py-4">
                            ...
                            <div className="hidden md:flex items-center space-x-3 ml-4">
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center space-x-2 px-3 py-2 rounded-md border border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700 transition-colors"
                                    title="Sair da conta"
                                >
                        ...
                        <div className="fixed right-0 top-0 h-full w-80 bg-white shadow-lg">
                            <div className="p-6">
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <button onClick={() => setShowSidebar(false)} title="Fechar menu">
                                        <X className="w-6 h-6" />
                                    </button>
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="pt-4 border-t">
                                        <button
                                            onClick={handleLogout}
                                            className="w-full inline-flex items-center justify-center space-x-2 px-4 py-3 rounded-md border border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700 transition-colors"
                                            title="Sair da conta"
                                        >
                                            <LogOut className="w-4 h-4" />
                                            <span>Sair</span>
                            ...
                            <div className="p-6">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    <button
                                        ...
                                        className="p-4 border rounded-lg hover:bg-cyan-50 transition-colors text-center"
                                    >
                                        <div className="text-2xl mb-2">🏖️</div>
                                        <p className="text-sm font-medium">Gestão Turística</p>
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                                    ...
                                    <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-lg p-6 border border-cyan-200">
                                        <div className="flex items-center mb-4">
                                            ...
                                            <div>
                                                <h3 className="font-semibold text-gray-900">Gestão Turística</h3>
                                                <p className="text-sm text-gray-600">Módulos de turismo</p>
                                            </div>
                                        </div>
                                        <div className="space-y-2">
                                            <button
                                                onClick={() => router.push('/turismo')}
                                                className="w-full text-left p-2 rounded hover:bg-cyan-200 transition-colors font-medium"
                                            >
                                                <span className="text-sm">🏖️ Gestão Turística</span>
                                            </button>
                                            <button
                                                onClick={() => router.push('/dashboard/leiloes')}
                                                className="w-full text-left p-2 rounded hover:bg-cyan-200 transition-colors"
                                            >
                                                <span className="text-sm">🔨 Leilões</span>
                                            </button>
                                            <button
                                            ...
                                            <button
                                                onClick={() => router.push('/dashboard/google-hotel-ads')}
                                                className="w-full text-left p-2 rounded hover:bg-cyan-200 transition-colors"
                                            >
                                                <span className="text-sm">🏨 Google Hotel Ads</span>
                                            </button>
                                            <button
                                                onClick={() => router.push('/dashboard/ota-sync')}
                                                className="w-full text-left p-2 rounded hover:bg-cyan-200 transition-colors"
                                            >
                                                <span className="text-sm">🌐 Sincronização OTA</span>
                                            </button>
                                            <button
                                                onClick={() => router.push('/dashboard/excursoes')}
                                                className="w-full text-left p-2 rounded hover:bg-cyan-200 transition-colors"
                                            >
                                                <span className="text-sm">🚌 Excursões</span>
                                            </button>
                                            <button
                                                onClick={() => router.push('/dashboard/viagens-grupo')}
                                                className="w-full text-left p-2 rounded hover:bg-cyan-200 transition-colors"
                                            >
                                                <span className="text-sm">👥 Viagens em Grupo</span>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-lg p-6 border border-teal-200">
                                        <div className="flex items-center mb-4">
                                            ...
                                            <div>
                                                <h3 className="font-semibold text-gray-900">Cotações</h3>
                                                <p className="text-sm text-gray-600">Orçamentos e propostas</p>
                                            </div>
                                        </div>
                                        <div className="space-y-2">
                                            <button
                                            ...
                                            <button
                                                onClick={() => router.push('/cotacoes/new')}
                                                className="w-full text-left p-2 rounded hover:bg-teal-200 transition-colors"
                                            >
                                                <span className="text-sm">➕ Nova Cotação</span>
                                            </button>
                                            <button
                                                onClick={() => router.push('/cotacoes/templates')}
                                                className="w-full text-left p-2 rounded hover:bg-teal-200 transition-colors"
                                            >
                                                <span className="text-sm">📋 Templates</span>
                                            </button>
                                            <button
                                                onClick={() => router.push('/cotacoes/hoteis')}
                                                className="w-full text-left p-2 rounded hover:bg-teal-200 transition-colors"
                                            >
                                                <span className="text-sm">🏨 Hotéis</span>
                                            </button>
                                    ...
                                    <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg p-6 border border-amber-200">
                                        <div className="flex items-center mb-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600">Configurações e monitoramento</p>
                                            </div>
                                        </div>
                                        <div className="space-y-2">
                                            <button
                                                onClick={() => router.push('/settings')}
                                                className="w-full text-left p-2 rounded hover:bg-amber-200 transition-colors"
                                            >
                                                <span className="text-sm">⚙️ Configurações</span>
                                            </button>
                                            <button
                                                ...
                                                className="w-full text-left p-2 rounded hover:bg-amber-200 transition-colors"
                                            >
                                                <span className="text-sm">🗺️ APIs e Mapas</span>
                                            </button>
                                            <button
                                                onClick={() => window.open('http://localhost:5050', '_blank')}
                                                className="w-full text-left p-2 rounded hover:bg-amber-200 transition-colors"
                                            >
                                                <span className="text-sm">🤖 Agentes SRE</span>
                                            </button>
                                            <button
                                                onClick={() => router.push('/rsv-360-ecosystem')}
                                                className="w-full text-left p-2 rounded hover:bg-amber-200 transition-colors"
                                            >
                                                <span className="text-sm">📊 Ecossistema RSV360</span>
                                            </button>
                                        </div>
                                    </div>
