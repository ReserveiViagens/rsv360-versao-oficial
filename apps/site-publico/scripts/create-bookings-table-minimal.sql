-- ===================================================================
-- SCRIPT SQL MÍNIMO - Apenas tabela bookings (sem users)
-- Use este script se quiser criar apenas a tabela de reservas
-- ===================================================================
...
CREATE TABLE IF NOT EXISTS bookings (
    ...
    customer_id INTEGER, -- Opcional, para quando a tabela users existir
