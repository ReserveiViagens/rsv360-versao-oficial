...
exports.up = function (knex) {
  return knex.schema
    .createTable("website_content", function (table) {
...
exports.down = function (knex) {
  return knex.schema
    .dropTableIfExists("website_content_history")
    .then(() => knex.schema.dropTableIfExists("website_settings"))
    .then(() => knex.schema.dropTableIfExists("website_content"));
};
